...
typedef struct {
    ...
    uint32_t RESET_MODE;
    uint32_t RESET_MODE_n_bits;
    uint32_t RESET_MODE_bin_pt;
    // uint32_t RESET_MODE_attr;
    uint32_t AGC_OVERRIDE;
    uint32_t AGC_OVERRIDE_n_bits;
    uint32_t AGC_OVERRIDE_bin_pt;
    // uint32_t AGC_OVERRIDE_attr;
    uint32_t RX_LENGTH;
